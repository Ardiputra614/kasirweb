                            ...
                            <form action="{{ route('cart.store') }}" method="post">
                                ...
                                <div class="mb-2 h-full w-full overflow-hidden rounded bg-white p-2 shadow-md">
                                    ...
                                    <div class="p-2">
                                        ...
                                        <h5 class="text-sm font-medium uppercase tracking-tight hover:text-[#f54c2a]">
                                            {{ $product->nama_produk }}
                                        </h5>

                                        <div class="mt-1">
                                            <span class="inline-block text-lg font-semibold text-[#f53b16]">Rp.
                                                {{ number_format($product->harga_jual_grosir_member, 0, ',', '.') }}
                                            </span>
                                        </div>
                                        ...
                                        <button type="submit" class="rounded-md bg-[#f54c2a] p-1 text-white md:p-2"><i
