                                    ...
                                    <div class="p-2">
                                        ...
                                        <div class="mt-1">
                                            <span class="inline-block text-lg font-semibold text-[#f53b16]">Rp.
                                                {{ number_format($product->harga_jual_member, 0, ',', '.') }}
                                            </span>
                                        </div>
                                        ...
                                        <button type="submit" class="rounded-md bg-[#f53b16] p-1 text-white md:p-2"><i
