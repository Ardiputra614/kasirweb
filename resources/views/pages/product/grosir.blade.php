                                    ...
                                    <div class="p-2">
                                        ...
                                        <div class="mt-1">
                                            <span class="inline-block text-lg font-semibold text-[#f53b16]">Rp.
                                                {{ number_format($product->harga_jual_grosir, 0, ',', '.') }}
                                            </span>
                                        </div>
                                        ...
                                        <button id="tambah" type="submit" value="{{ $product->kd_produk }}"
